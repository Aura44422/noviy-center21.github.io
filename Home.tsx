...
const Home: React.FC = () => {
  ...
  const galleryImages: GalleryImage[] = [
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-06 at 11.14.44.jpeg',
      alt: 'Фотография центра 1'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-06 at 11.14.46.jpeg',
      alt: 'Фотография центра 2'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-06 at 11.14.43.jpeg',
      alt: 'Фотография центра 3'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-06 at 11.14.45.jpeg',
    ...
    <div className="home">
      ...
      <section className="hero-section">
            ...
            <div className="hero-text">
              <h1 className="hero-title">
                ...
                <span className="hero-highlight">
                  <img src="/assets/logo-noviy.png" alt="НОВЫЙ" className="hero-logo-image" />
                </span>
              </h1>
        ...
        <div className="hero-image">
          <img 
            src="/assets/photoMAKET/photo_2025-08-06_16-13-53 (1) (1).jpg" 
