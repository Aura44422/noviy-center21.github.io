...
const Tenants: React.FC = () => {
  ...
  const tenantsGalleryImages: GalleryImage[] = [
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.41.26.jpeg',
      alt: 'Наши арендаторы фото 1'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.39.37.jpeg',
      alt: 'Наши арендаторы фото 2'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.40.39.jpeg',
      alt: 'Наши арендаторы фото 3'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.42.36.jpeg',
      alt: 'Наши арендаторы фото 4'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.11.54.jpeg',
      alt: 'Наши арендаторы фото 5'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.10.42.jpeg',
      alt: 'Наши арендаторы фото 6'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.09.03.jpeg',
      alt: 'Наши арендаторы фото 7'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.07.47 (1).jpeg',
      alt: 'Наши арендаторы фото 8'
    },
    {
      src: '/assets/photoMAKET/WhatsApp Image 2025-08-17 at 20.06.09.jpeg',
        ...
        <div className="container">
          ...
          <div className="floor-plan-card">
            <div className="floor-plan-container" onClick={openFloorPlanModal}>
              <img 
                src="/assets/photoMAKET/Screenshot_2.png" 
